...
struct background
{
  ...
  /** NEW */
  double omega_cdm;
  double Omega_b_tilde;     /**< pow(H0/70 km/s/Mpc,2)*Omega0_b */
  double Omega_g_tilde;     /**< pow(H0/70 km/s/Mpc,2)*Omega0_g */
  double Omega_cdm_tilde;    /**< pow(H0/70 km/s/Mpc,2)*Omega0_cdm */ 
  ...
  double beta_4;             /**< (constant) coupling constant for bin 4*/
  double beta_5;             /**< (constant) coupling constant for bin 5*/
  double beta_6;             /**< (constant) coupling constant for bin 6*/
  double beta_7;             /**< (constant) coupling constant for bin 7*/
  ...
  /* NEW */
  int index_bg_beta;         /**< Coupling beta */
  int index_bg_beta_prime;   /**< Derivative of beta wtr to the redshift */
  /* */
  ...
  //@{
  /** NEW */
  int index_bi_rho_cdm;/**< {B} cdm density */ 
  /* */
