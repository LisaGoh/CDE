...
enum target_names {Omega_dcdmdr, omega_dcdmdr, Omega_ini_dcdm, omega_ini_dcdm, sigma8};
/* Important: Keep this number equal to the number of target_names */
#define _NUM_TARGETS_ 5
/* Important: add one for each new target_names */
enum computation_stage {cs_background, cs_thermodynamics, cs_perturbations, cs_primordial, cs_fourier, cs_transfer, cs_spectra};
