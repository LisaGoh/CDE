...
cdef class Class:
    ...
    #################################
    # gives f(z)*sigma8(z) where f(z) is the scale-inbdependent growth factor
    ...
    def get_current_derived_parameters(self, names):
        ...
        for name in names:
            if name == 'h':
                ...
                value = self.ba.Omega0_b+self.ba.Omega0_cdm+self.ba.Omega0_ncdm_tot + self.ba.Omega0_dcdm
            elif name == 'omega_m':
                value = (self.ba.Omega0_b+self.ba.Omega0_cdm+self.ba.Omega0_ncdm_tot + self.ba.Omega0_dcdm)*self.ba.h**2
            elif name == 'xi_idr':
             ...
             # NEW	
                ...
                value = self.ba.omega_cdm
            elif name == 'l_a':
                value = 3.141593*self.th.da_rec*(1.+self.th.z_rec)/self.th.rs_rec
            elif name == 'beta_1':
                value = self.ba.beta_1
            elif name == 'beta_2':
                value = self.ba.beta_2
            elif name == 'beta_3':
                value = self.ba.beta_3
            elif name == 'beta_4':
                value = self.ba.beta_4
            elif name == 'beta_5':
                value = self.ba.beta_5
            elif name == 'beta_6':
                value = self.ba.beta_6
            elif name == 'beta_7':
                value = self.ba.beta_7
            elif name == 'eta_0':
                value = self.fo.eta_0
            elif name == 'c_min':
                value = self.fo.c_min
            elif name == 'S8':
                value = self.fo.sigma8[self.fo.index_pk_m]*pow((self.ba.Omega0_b + self.ba.Omega0_cdm)/0.3,0.5)
            elif name == 'n_s':
                value = self.pm.n_s
            elif name == 'alpha_s':
