...
int input_shooting(struct file_content * pfc,
  ...
  enum computation_stage target_cs[] = {cs_background,     /* computation stage for target 'Omega_dcdmdr' */
                                        ...
                                        cs_background,     /* computation stage for target 'omega_ini_dcdm' */
                                        cs_fourier};       /* computation stage for target 'sigma8' */
...
int input_try_unknown_parameters(double * unknown_parameter,
  ...
  if (pfzw->required_computation_stage >= cs_fourier){
    if (input_verbose>2)
      printf("Stage 5: fourier\n");
...
int input_read_parameters_species(struct file_content * pfc,
  ...
  if (N_ncdm > 0){
    ...
    for (n=0; n<N_ncdm; n++){
      if (pba->M_ncdm[n]!=0.0){
        ...
        /* Complete set of parameters */
        pba->Omega0_ncdm[n] = pba->M_ncdm[n]/(0.7*0.7);
      }
      /* Set default value
 ...
 /**/
  ...
  if (flag2 == _TRUE_)
    pba->Omega0_dcdmdr = param2/(0.7*0.7);
